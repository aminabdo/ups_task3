...
import com.shoohna.happytimes.ui.home.ui.orderData.OrderDataFragment
...
class OrderDataScreenTest {
    ...
    fun setUp() {
        ...
        navController.navigate(R.id.orderDataFragment)

        activity = mActivityTestRule.activity
        mActivityTestRule.activity
            .supportFragmentManager
            .beginTransaction()
            .replace(R.id.nav_host_fragment, OrderDataFragment())
            .addToBackStack(null)
